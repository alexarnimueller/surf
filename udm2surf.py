...
xsd_file = "data/udm_schema/udm_6_0_0.xsd"
validate = True
...
# read UDM schema
with open("data/udm_schema/udm_6_0_0.xsd", "r") as f:
    raw_xsd = f.read()
...
for reaction in reactions.find_all("REACTION"):
    ...
    try:
        ...
        logger.error(f"One of these reactant IDs {react_ids} was not found in molecules! Skipping reaction {rxn_id}")
        continue
    # Product
    try:
